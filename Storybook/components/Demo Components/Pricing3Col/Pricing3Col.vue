<template>
    <div class="bg-gray-100 py-16 shadow">
    ...
    <div class="bg-white">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mt-20 flow-root">
                <div
                    class="isolate -mt-16 grid max-w-sm grid-cols-1 gap-y-16 divide-y divide-gray-100 sm:mx-auto lg:-mx-8 lg:mt-0 lg:max-w-none lg:grid-cols-3 lg:divide-y-0 lg:divide-x xl:-mx-4"
                >
                    <div
                        v-for="tier in tiers"
                        :key="tier.id"
                    ...
                    >
                        ...
                        <a
                            ...
                            class="mt-10 block rounded-md bg-secondary py-2 px-3 text-center text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                            >Buy plan</a
                        >
                        <p
                            class="mt-10 text-sm font-semibold leading-6 text-gray-900"
                        >
                            {{ tier.description }}
                        </p>
                        <ul
